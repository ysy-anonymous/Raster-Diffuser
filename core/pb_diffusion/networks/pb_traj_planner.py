...
from core.pb_diffusion.networks.diffusion.temporal_cond import TemporalUnet_WCond
...
class PBTrajPlanner(nn.Module):
    ...
    def __init__(self, network_config):
        ...
        self.diff_decoder = TemporalUnet_WCond(**self.decoder_config) # diffusion trajectory decoder
