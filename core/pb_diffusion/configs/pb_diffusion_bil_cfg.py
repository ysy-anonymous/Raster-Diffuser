...
class PBDiffusionBILConfig:
    def __init__(self):
        ...
        self.network_config = {
            ...
            'unet_decoder': { # horizon: 32
                ...
                'network_config': {
                    ...
                    'energy_mode': True, # set this False while training, True while inferencing..
        ...
        self.trainer = {
            ...
            'results_folder': '/exhdd/seungyu/diffusion_motion/trained_weights/pb_bil_diffusion/run1',
