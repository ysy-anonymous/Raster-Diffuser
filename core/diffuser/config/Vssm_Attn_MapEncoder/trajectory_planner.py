...
#     def __init__(self, in_channels, input_size, d_model, dws_kernel, state_dim: List, ssm_exp_ratio: List, vssm_drop,
#                          patch_size: List, attn_drop, num_heads, ffn_dim, ffn_dropout, num_layers: List):
        self.network_config = {
            'map_encoder': {
                'in_channels': 3,
                'out_channels': 256,
        ...
        self.trainer = {
            ...
            'optimizer': {
                'name': "adamw",
                'learning_rate': 2.0e-4, # default set to 1.0e-4
                'weight_decay': 1.0e-6
            },
            'lr_scheduler': {
                'name': "cosine",
