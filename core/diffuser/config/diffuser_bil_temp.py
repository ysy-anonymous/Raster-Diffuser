    ...
    def __init__(self):
        ...
        self.network_config = {
            ...
            'diffusion_decoder': { # horizon: 32
                ...
                'upsample_size': (8, 8),
                'bilatent_dim': 64,
                'bilatent_sigma': 1.2, # 1.2 as default value
                ...
                'bilatent_weight_sharing': False # whether to share weights for the spatial refine and point corrector blocks across iterations. Default as True.
            }
        }
    ...
    def __init__(self):
        ...
        self.network_config = {
            ...
            'diffusion_decoder': { # horizon: 32
                ...
                'bilatent_dim': 256, # 64 as default
                'bilatent_sigma': 1.2, # 1.2 as default value, smaller value yields more local footprint of trajectory.
