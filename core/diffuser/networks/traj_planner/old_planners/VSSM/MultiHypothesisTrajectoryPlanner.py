...
from core.diffuser.networks.map_encoder.vssmMapEncoder import VSSMapEncoder
from core.diffuser.networks.diffusion_decoder.MultiHypothesisDiffusionDecoder import MultiHypothesisDiffusionTrajDecoder
...
class MultiHypothesisTrajectoryPlanner(nn.Module):
    """
    ...
    def __init__(self, network_config: Dict):
        ...
        self.diff_decoder = MultiHypothesisDiffusionTrajDecoder(**self.decoder_config) # diffusion trajectory decoder
