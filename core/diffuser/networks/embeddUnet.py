...
from core.diffuser.networks.vit import ViT
...
# transformer based conditional encodings + \
# Unet based diffusion with latent transformer
class ConditionalUnet1D(nn.Module):
    def __init__(
        ...
        # here is the total dimension for UNet based diffusion model processing
