...
class BiLatentMultiHypoDiffTrajDecoder(nn.Module):
    """
    ...
    def __init__(self, stem_channels: int, channel_scheme: List, kernel_scheme: List, stride_scheme: List,
                 padding_scheme: List, out_padding_scheme: List, group_scheme: List, activation, norm_layer, 
                 n_groups: int, timestep_dim:int, map_cond_dim:int, obs_dim:int, map_size: tuple, patch_size: tuple,
                 num_hypothesis: int, token_dim: int, hidden_dim:int, mhypo_iters: int, 
...
def main():    
    ...
    diffusion_decoder = BiLatentMultiHypoDiffTrajDecoder(stem_channels=64, channel_scheme=[128, 256, 512], kernel_scheme=[2, 2, 2], 
                                            ...
                                            num_hypothesis=8, token_dim=256, hidden_dim=512, mhypo_iters=3,
