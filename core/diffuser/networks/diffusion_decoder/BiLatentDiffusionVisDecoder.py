...
from core.diffuser.networks.diffusion_decoder.helpers.BiFusionVis import BiDirectionalFusionBlock
...
class BiLatentDecoderForVis(nn.Module):
    """
    ...
    def forward(self, 
        ...
        x0_hat_ref, raster_image_for_vis = self.bi_latent_adjuster(map_feat, x0_hat, time_embed)
        ...
        # raster_image_for_vis: (num_iters, B, Hs, Ws)
        return eps_pred_ref, raster_image_for_vis