...
def main():    
    ...
    diffusion_decoder = MultiResDiffusionDecoder(stem_channels=64, channel_scheme=[128, 256, 512], kernel_scheme=[2, 2, 2], 
                                            ...
                                            timestep_dim=64, cond_dim=320, map_cond_dim=128, map_size=(8, 8), patch_size=(4, 4),
                                            T_coarse=8, T_mid=16, T_fine=32, refiner_in_dim=256, refiner_hidden_dim=384, use_aux_loss=False)
