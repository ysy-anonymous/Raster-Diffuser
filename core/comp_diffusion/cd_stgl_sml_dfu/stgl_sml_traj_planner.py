...
# Trajectory Planner
class CompTrajPlanner(nn.Module):
    """
    ...
    def __init__(self, network_config):
        ...
        self.diff_decoder = Unet1D_TjTi_Stgl_Cond_V1(**self.decoder_config) # diffusion trajectory decoder
        
        # self.energy_mode = self.diff_decoder.energy_mode
        self.input_t_type = self.diff_decoder.input_t_type
                
    def forward(self, sample, timestep, tj_cond, map_cond, force_dropout=False, half_fd=False):
