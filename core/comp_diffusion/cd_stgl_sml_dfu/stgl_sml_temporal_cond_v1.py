...
from core.comp_diffusion.cond_cp_dfu.sml_temporal_dd_v1 import ResidualTemporalBlock_dd
...
class Unet1D_TjTi_Stgl_Cond_V1(nn.Module):
    ...
    def forward(self, x, time,
        ...
        # Set this to True
        if self.cat_t_w:
            t_feat = torch.cat([t_feat, st_ovlp_feat, end_ovlp_feat, st_token, end_token, map_cond], dim=-1) # orginally map_cond isn't concatenated to t_feat.
        else:
