...
class CompDiffusionConfigV2:
    def __init__(self):
        ...
        self.trainer = {
            'ema_decay': 0.995, 
            'train_batch_size': 512, # 128 as default
            'train_lr': 2e-4, # 2e-4 as default
            'gradient_accumulate_every': 1,
            'step_start_ema': 2000, # default as 2000
            'update_ema_every': 10,
            'log_freq': 100,
            ...
            'device': 'cuda:6',
            'results_folder': '/exhdd/seungyu/diffusion_motion/trained_weights/comp_diffusion_v2/run1',
            'n_train_steps': 21000, ## new args -> number of training steps
            'trainer_dict': { 
                'lr_scheduler': {
                    'name': "cosine",
