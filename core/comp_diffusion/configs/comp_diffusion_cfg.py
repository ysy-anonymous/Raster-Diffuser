...
class CompDiffusionConfig:
    def __init__(self):
        ...
        self.trainer = {
            ...
            'device': 'cuda:4',
            'results_folder': '/exhdd/seungyu/diffusion_motion/trained_weights/comp_diffusion/run1',
            'n_train_steps': 41000, ## new args -> number of training steps
            'trainer_dict': {
                'lr_scheduler': {
                    'name': "cosine",
