...
from core.rediffuser.trainer.rediff_trainer import ReDiffTrainer # Trainer for PB Diffusion
...
def parse_argument():
    ...
    parser.add_argument('--config_path', type=str, default='/exhdd/seungyu/diffusion_motion/core/networks/rediffuser/configs/rediff_cfg.py', help='set config file path')
...
def main():
    ...
    diffusion_model, config_dict = build_rediff_from_cfg(train_model)
    ...
    trainer = ReDiffTrainer(diffusion_model=diffusion_model, dataset=dataset, **config_dict['trainer'])
