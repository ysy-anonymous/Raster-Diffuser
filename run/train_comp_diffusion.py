...
from core.comp_diffusion.cd_stgl_sml_dfu.stgl_sml_training_v1 import Stgl_Sml_Trainer_v1 # Trainer STGL SML V1
from core.comp_diffusion.datasets.rrt_map import RRTCompDataset # dataset for training comp_diffusion
...
def main():
    ...
    diffusion_model, config_dict = build_comp_diff_from_cfg(train_model)
    diffusion_model = diffusion_model.to(config_dict['trainer']['device'])
    ...
    trainer = Stgl_Sml_Trainer_v1(diffusion_model=diffusion_model, dataset=dataset, **config_dict['trainer'])
